...
// 主肉垫居中偏下，4 脚趾顶部弧形排列；趾宽 0.12 < 间距 0.18 → 四趾独立清晰
const PAW_SHAPES = [
  [0.5, 0.68, 0.19, 0.21], // 主垫
  [0.22, 0.36, 0.06, 0.085], // 趾 1（左外）
  [0.4, 0.27, 0.06, 0.085], // 趾 2
  [0.6, 0.27, 0.06, 0.085], // 趾 3
  [0.78, 0.36, 0.06, 0.085] // 趾 4（右外）
]
